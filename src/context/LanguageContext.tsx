...
const translations = {
  es: {
    ...
    'resume.proj7_title': 'RENFE Cercanías (2026)',
    ...
    'resume.renfe_cercanias_desc': 'Información sobre RENFE Cercanías. Proyecto personal.',
    'resume.present': 'Ahora',
  ...
  en: {
    ...
    'resume.renfe_cercanias_desc': 'Information about RENFE Cercanías (Spanish train service). Personal project.',
    'resume.present': 'Now',
  ...
  da: {
    ...
    'resume.proj4_title': 'Urban Sketchers (2025)',
    'resume.this_web': 'Denne netside (2025)',
    'resume.proj6_title': 'Alex Lomart (2019)',
    'resume.proj7_title': 'RENFE Cercanías (2026)',
    ...
    'resume.renfe_cercanias_desc': 'Information om RENFE Cercanías (spansk togservice). Personligt projekt.',
    'resume.present': 'Nu',
